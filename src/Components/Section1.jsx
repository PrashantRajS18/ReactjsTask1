...
const Section1 = (props)=>{
  return(
      <>
              {props.item.stories_list[0]  ? (<div className="container" >
          <div className="sec1" key={props.item.stories_list[0].feid}>
              <div className='sec1sub1  ' >
                   <a href={props.item.stories_list[0].industry_details[0].slug} style={{color:"#096FFA"}} className="Montbold"  >{props.item.stories_list[0].industry_details[0].name}</a>
